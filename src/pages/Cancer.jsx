...
const CancerInstitute = () => {
  ...
  const sidebarCategories = [
    { id: 'overview', name: 'Cancer Overview', icon: <Book className="w-5 h-5" /> },
    { id: 'common', name: 'Common Cancer Types', icon: <TrendingUp className="w-5 h-5" /> },
    { id: 'rare', name: 'Rare Cancers', icon: <AlertCircle className="w-5 h-5" /> },
    { id: 'prevention', name: 'Prevention & Screening', icon: <Heart className="w-5 h-5" /> },
    { id: 'treatment', name: 'Treatment Options', icon: <Microscope className="w-5 h-5" /> },
    { id: 'support', name: 'Patient Support', icon: <Users className="w-5 h-5" /> },
    { id: 'research', name: 'Research & Trials', icon: <Activity className="w-5 h-5" /> }
  ];
  ...
  const commonCancers = [
    {
      ...
      mortality: 'Moderate',
      survival: '90%',
      description: 'The most common cancer in women, also affects men. Early detection significantly improves outcomes.',
    ...
    },
    {
      ...
      survival: '98%',
      description: 'Most common cancer in men. Often slow-growing with excellent survival rates when detected early.',
    ...
    },
    {
      ...
      mortality: 'High',
      survival: '25%',
      description: 'Leading cause of cancer death. Strongly linked to smoking, but also affects non-smokers.',
    ...
    },
    {
      ...
      mortality: 'Moderate',
      survival: '65%',
      description: 'Cancer of the colon or rectum. Highly preventable with regular screening.',
      riskFactors: ['Age', 'Diet', 'Family history', 'Inflammatory bowel disease'],
    ...
    },
    {
      ...
      mortality: 'Variable',
      survival: '94%',
      description: 'Most serious type of skin cancer. Can spread rapidly if not caught early.',
    ...
    },
    {
      ...
      mortality: 'Moderate',
      survival: '78%',
      description: 'More common in men and older adults. Often detected early due to visible symptoms.',
  ...
  const rareCancers = [
    {
      ...
      mortality: 'Very High',
      survival: '12%',
      description: 'Often diagnosed at advanced stages. Aggressive form with limited treatment options.'
    },
    {
      ...
      mortality: 'High',
      survival: '36%',
      description: 'Complex tumors affecting the central nervous system with varying prognoses.'
    },
    {
      name: 'Ovarian Cancer',
      incidence: 'Moderate',
    ...
    },
    {
      ...
      mortality: 'High',
      survival: '21%',
      description: 'Increasing incidence often linked to hepatitis and fatty liver disease.'
    }
  ];
      ...
      case 'overview':
        return (
          <div className="space-y-8">
            ...
            >
              <h1 className="text-4xl font-bold text-[#8e24aa] mb-6">Understanding Cancer</h1>
              <div className="bg-blue-50 border-l-4 border-blue-400 p-6 mb-6">
                <p className="text-lg text-blue-800">
                  Cancer is a group of diseases characterized by the uncontrolled growth and spread of abnormal cells. Cancers are classified by the type of tissue in which they originate and by their primary location in the body.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
                <div className="bg-white p-6 rounded-xl shadow-lg border border-gray-200">
                  ...
                  <p className="text-3xl font-bold text-[#8e24aa] mb-2">2.0 Million</p>
              ...
              <div className="bg-white rounded-xl shadow-lg p-8 border border-gray-200">
                <h2 className="text-2xl font-bold text-gray-800 mb-4">Key Cancer Facts</h2>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <h3 className="text-lg font-semibold mb-3 text-[#8e24aa]">What Causes Cancer?</h3>
                    <p className="text-gray-700 mb-4">
                      Cancer is caused by genetic changes that affect three main types of genes: proto-oncogenes, tumor suppressor genes, and DNA repair genes.
                    </p>
                  ...
                  <div>
                    <h3 className="text-lg font-semibold mb-3 text-[#8e24aa]">Prevention Strategies</h3>
                    <ul className="text-gray-600 space-y-2">
          ...
          <div className="space-y-8">
            ...
            >
              <div className="flex justify-between items-center mb-6">
                <h1 className="text-4xl font-bold text-[#8e24aa]">Common Cancer Types</h1>
              ...
              <div className="bg-yellow-50 border-l-4 border-yellow-400 p-4 mb-6">
                <p className="text-yellow-800">
                  The most common cancers in the United States are breast, prostate, lung, and colorectal cancers, which account for almost 50% of all new cancer cases.
                </p>
              </div>
                    ...
                    <div className="p-6">
                      <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between">
                        <div className="flex-1">
                          <h3 className="text-2xl font-bold text-[#8e24aa] mb-3">{cancer.name}</h3>
                          <p className="text-gray-700 mb-4">{cancer.description}</p>
                          
                          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                            <div className="bg-blue-50 p-3 rounded-lg">
                              <p className="text-sm text-blue-600 font-medium">New Cases (2025)</p>
                              <p className="text-xl font-bold text-blue-800">{cancer.newCases}</p>
                            </div>
                            <div className="bg-green-50 p-3 rounded-lg">
                              <p className="text-sm text-green-600 font-medium">5-Year Survival</p>
                              <p className="text-xl font-bold text-green-800">{cancer.survival}</p>
                            </div>
                            <div className={`p-3 rounded-lg ${
                              cancer.mortality === 'Low' || cancer.mortality === 'Low-Moderate' 
                                ? 'bg-green-50' 
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                              ...
                              <div className="flex flex-wrap gap-2">
                                {cancer.riskFactors.map((factor, idx) => (
                                  <span key={idx} className="bg-red-100 text-red-700 px-2 py-1 rounded-full text-sm">
                                    {factor}
                                  </span>
                                ))}
                              </div>
                            ...
                            <div>
                              <h4 className="font-semibold text-gray-800 mb-2">Screening:</h4>
                              <p className="text-gray-600 text-sm">{cancer.screening}</p>
                            </div>
                          </div>
                        </div>
                      </div>
        ...
        return (
          <div className="space-y-8">
            <motion.div
              ...
              transition={{ duration: 0.6 }}
            >
              <h1 className="text-4xl font-bold text-[#8e24aa] mb-6">Rare Cancers</h1>
              <div className="bg-orange-50 border-l-4 border-orange-400 p-4 mb-6">
                <p className="text-orange-800">
                  Rare cancers account for about 20% of all cancer diagnoses. While less common, they often require specialized treatment approaches and research.
                </p>
              </div>
                ...
                {rareCancers.map((cancer, index) => (
                  ...
                  >
                    <div className="flex items-start justify-between mb-4">
                      <h3 className="text-2xl font-bold text-[#8e24aa]">{cancer.name}</h3>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      <div className="bg-blue-50 p-3 rounded-lg">
                        <p className="text-sm text-blue-600 font-medium">Incidence</p>
                        <p className="text-lg font-bold text-blue-800">{cancer.incidence}</p>
                      </div>
                      <div className="bg-red-50 p-3 rounded-lg">
                        <p className="text-sm text-red-600 font-medium">Mortality Risk</p>
                        <p className="text-lg font-bold text-red-800">{cancer.mortality}</p>
                      </div>
                      <div className="bg-green-50 p-3 rounded-lg">
                        <p className="text-sm text-green-600 font-medium">5-Year Survival</p>
                        <p className="text-lg font-bold text-green-800">{cancer.survival}</p>
                      </div>
                    </div>
                  </motion.div>
                ))}
        ...
        return (
          <div className="space-y-8">
            <motion.div
              ...
              transition={{ duration: 0.6 }}
            >
              <h1 className="text-4xl font-bold text-[#8e24aa] mb-6">Treatment Options</h1>
              <div className="bg-green-50 border-l-4 border-green-400 p-4 mb-6">
                <p className="text-green-800">
                  Cancer treatment has evolved significantly, with many options available depending on cancer type, stage, and individual factors. Treatment plans are often personalized and may combine multiple approaches.
                </p>
              </div>
              ...
              <div className="grid gap-6">
                {treatmentOptions.map((treatment, index) => (
                  ...
                  >
                    <div className="flex items-start justify-between mb-4">
                      <h3 className="text-2xl font-bold text-[#8e24aa]">{treatment.type}</h3>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        <h4 className="font-semibold text-gray-800 mb-2">Best Suited For:</h4>
                        <p className="text-gray-600">{treatment.suitability}</p>
                      </div>
                      <div>
                        <h4 className="font-semibold text-gray-800 mb-2">Key Considerations:</h4>
                        <p className="text-gray-600">{treatment.considerations}</p>
                      </div>
                    </div>
                  </motion.div>
                ))}
        ...
        return (
          <div className="space-y-8">
            <motion.div
              ...
              transition={{ duration: 0.6 }}
            >
              <h1 className="text-4xl font-bold text-[#8e24aa] mb-6">Patient Support Resources</h1>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-6">
                  ...
                  <div className="bg-purple-50 p-4 rounded-lg mb-4">
                    <p className="text-purple-800 text-2xl font-bold">*939*101#</p>
                    <p className="text-purple-600">24/7 Cancer Support Helpline</p>
                  </div>
                  <p className="text-gray-600">Immediate assistance for cancer patients and families</p>
                </div>
    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 py-8">
          ...
          >
            ...
            <p className="text-xl opacity-90 max-w-3xl mx-auto">
              Comprehensive, evidence-based cancer information from leading medical institutions. 
              Your trusted resource for understanding, preventing, and treating cancer.
            </p>
          </motion.div>
        </div>
      </div>
          ...
          >
            <div className="bg-white rounded-xl shadow-lg border border-gray-200 sticky top-8">
              <div className="p-6 border-b border-gray-200">
                <h2 className="text-xl font-bold text-gray-800">Cancer Information</h2>
              </div>
              <nav className="p-4">
                {sidebarCategories.map((category) => (
                  ...
                  >
                    ...
                    <ChevronRight className={`w-4 h-4 ml-auto transition-transform ${
                      selectedCategory === category.id ? 'rotate-90 text-white' : 'text-gray-400'
                    }`} />
                  </motion.button>
                ))}
              </nav>
      ...
      <footer className="bg-gray-100 border-t border-gray-200 mt-12">
        <div className="max-w-7xl mx-auto px-4 py-6 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-600 text-sm">© 2025 National Cancer Information Center. All rights reserved.</p>
          <p className="text-gray-500 text-sm">Developed for awareness and education.</p>
        </div>
      </footer>
    </div>
  );
