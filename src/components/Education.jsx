    ...
    <div className="w-full h-3/4 py-16 bg-white text-[#5c007a] px-4">
      <div className="max-w-[1240px] mx-auto grid lg:grid-cols-3 ">
        <div className="lg:col-span-2 my-2 ">
          ...
          <p className="md:text-2xl sm:text-xl">"Patients need someone to hope and support them emotionally. No one fights cancer alone. If you want to fight this fight, I will fight with you!!!"</p>
        </div>
        <div className="my-4">
